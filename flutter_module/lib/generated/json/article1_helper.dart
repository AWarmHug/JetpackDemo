...
article1FromJson(Article data, Map<String, dynamic> json) {
	...
	if (json['tags'] != null) {
		data.tags = new List<Article1Tag>();
		(json['tags'] as List).forEach((v) {
			data.tags.add(new Article1Tag().fromJson(v));
		});
	}
	if (json['title'] != null) {
...
Map<String, dynamic> article1ToJson(Article entity) {
...
article1TagFromJson(Article1Tag data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> article1TagToJson(Article1Tag entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
